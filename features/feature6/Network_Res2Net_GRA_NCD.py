...
# Import Res2Net with error handling for webapp structure
try:
    from .Res2Net_v1b import res2net50_v1b_26w_4s
except ImportError:
    try:
        from features.feature6.Res2Net_v1b import res2net50_v1b_26w_4s
    except ImportError:
        print("Error: Could not import res2net50_v1b_26w_4s")
        raise
